...
const { createSession, markAttendance, getSessionStatus, closeSession, getMyAttendance, getCourseAttendance, exportMyAttendanceReport } = require('../controllers/attendance.controller');
...
router.get('/my/export', protect, requireRole('student'), exportMyAttendanceReport);
